...
| <a name="input_public_bucket"></a> [public\_bucket](#input\_public\_bucket) | Set to true to grant public read access (s3:GetObject) to all objects in the bucket. Only works if enable_policy_creation is enabled. | `bool` | `false` | no |
